          ...
          <div class="row mb-2">
            ...
            <div class="col-lg-4">
              <div class="pl-lg-4 pl-sm-0 pl-0">
                <label for="contractDetail_clientName" class="mb-0"><span style="color: #184A45FF;">@lang('Client Name')</span></label>
            ...
            <div class="col-lg-4">
              <div class="pr-lg-4 pr-sm-0 pr-0">
                <label for="c_start_date" class="mb-0"><span style="color: #184A45FF;">@lang('Start Date')</span></label>
            ...
            <div class="col-lg-4">
              <div class="pr-lg-4 pr-sm-0 pr-0">
                <label for="c_end_date" class="mb-0"><span style="color: #184A45FF;">@lang('End Date')</span></label>
            ...
            <div class="col-lg-12 mt-2">
              <div class="px-lg-4 px-sm-0 px-0">
                <label for="contractDetail_description" class="mb-0"><span style="color: #184A45FF;">@lang('Contract Description')</span></label>
            ...
            <div class="col-lg-4 mt-2 pr-0">
              <div class="pl-lg-4 pr-lg-2 pl-sm-0 pr-sm-3 pl-0 pr-3">
                <label for="c_location" class="mb-0"><span style="color: #184A45FF;">@lang('Contract Location')</span></label>
            ...
            <div class="col-lg-4 mt-2 pr-0">
              <div class="pl-lg-4 pr-lg-2 pl-sm-0 pr-sm-3 pl-0 pr-3">
                <label for="c_ammount" class="mb-0"><span style="color: #184A45FF;">@lang('Contract Ammount')</span></label>
            ...
            <div class="col-lg-4 mt-2 pl-0">
              <div class="pr-lg-4 pl-lg-2 pl-sm-3 pr-sm-0 pl-3 pr-0">
                <label for="c_category" class="mb-0"><span style="color: #184A45FF;">@lang('Contract Category')</span></label>
