...
<div class="content-wrapper py-0 my-2">
        ...
        <form method="POST" action="/services">
          ...
          <div class="row mt-1 mb-4">
            <div class="col-lg-4 col-md-4 col-sm-12">
              ...
              <span id="service_name_error" class="error-message text-danger"></span>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
              ...
              <span id="service_type_error" class="error-message text-danger"></span>
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 d-flex align-items-end  justify-content-center">
              <input type="submit" id="btn_save_service" class="btn form-control content-background w-50 text-white mt-2" name="submit" value="{{ ($service['id'] ?? '') !== '' ? __('lang.update') : __('lang.add') }}" />
  ...
  <script>
    $('#btn_save_service').click(function(event) {
      ...
      if (service_type === null) {
        $('#service_type_error').text('*Please select a service type.');
        event.preventDefault();
      }
