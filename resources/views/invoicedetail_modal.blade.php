                                ...
                                <div class="row mb-2">
                                  <div class="col-lg-8">
                                    <div class="pl-lg-4 pl-sm-0 pl-0">
                                      <label for="inovice_title" class="mb-0"><span style="color: #452C88;">@lang('Client Name')</span></label>
                                      <input type="text" disabled id="inoviceDetail_clientName" class="form-control" value="">
                                    </div>
                                  </div>
                                  <div class="col-lg-4">
                                    <div class="pr-lg-4 pr-sm-0 pr-0">
                                      <label for="inovice_title" class="mb-0"><span style="color: #452C88;">@lang('Invoice Date')</span></label>
                                      <input type="text" disabled class="form-control" id="inoviceDetail_date" value="">
                                    </div>
                                  </div>
                                  <div class="col-lg-12 mt-2">
                                    <div class="px-lg-4 px-sm-0 px-0">
                                      <label for="inovice_desc" class="mb-0"><span style="color: #452C88;">@lang('Invoice Description')</span></label>
                                  ...
                                  <div class="col-lg-6 mt-2 pr-0">
                                    <div class="pl-lg-4 pr-lg-2 pl-sm-0 pr-sm-3 pl-0 pr-3">
                                      <label for="inovice_desc" class="mb-0"><span style="color: #452C88;">@lang('Invoice Ammount')</span></label>
                                  ...
                                  <div class="col-lg-6 mt-2 pl-0">
                                    <div class="pr-lg-4 pl-lg-2 pl-sm-3 pr-sm-0 pl-3 pr-0">
                                      <label for="inovice_desc" class="mb-0"><span style="color: #452C88;">@lang('Invoice Service')</span></label>
