...
<body style="overflow-x: hidden;">
    ...
    <div class="container-fluid mx-2" style="margin-top: 20px !important;">
        <div class="row">
            <div class="col-md-6 col-lg-6 ml-auto" style="height: 90vh !important;">
                <div class="row">
                    <!-- Navbar Brand -->
                    ...
                    <form action="/set_password" method="post" style="width: 500px !important;">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12 mx-auto mb-0" style="margin-top: 60px;">
                                <input type="submit" style="background-color: #184A45FF;" class="font-weight-bold sign_up btn text-white btn-block py-2" name="submit" value="@lang('lang.set_password')">
