                    ...
                    <form action="tripStore" id="saveTrip" method="post">
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-2">
                                <label for="trip_desc">@lang('lang.invoice_desc')</label>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <label for="end_address">@lang('lang.invoice_category')</label>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <label for="end_address">@lang('lang.invoice_amount')</label>
                        ...
                        <div class="table-responsive   mt-3 ">
                            <div class=" offset-lg-10  offset-md-6 col-lg-2 col-md-6 col-sm-12 d-flex justify-content-end  text-right mt-2 mb-5">
                                ...
                                <div class="spinner-border spinner-border-sm text-white d-none" id="spinner"></div>
                                    <span id="text">@lang('lang.save_invoice')</span>
                                </button>
                            </div>
                        </div>
                    </form>
