          ...
          <div class="col-lg-12">
            <div class="row mx-1">
              <div class="col-lg-6 col-md-12 col-sm-12 my-2 pr-0" style="text-align: right;">
                <a>
                  <button class="btn content-background add-btn text-white"><span><i class=" fa-regular fa-file-lines"></i> @lang('lang.create_invoice')</span></button>
                </a>
                <a href="{{ route('add_invoice') }}">
                  <button class="btn add-btn text-white" style="background-color: #E95C20FF;"><span><i class="fa fa-plus"></i> @lang('lang.add_invoice')</span></button>
                </a>
              </div>
            ...
            <table id="qoute-table" class="display" style="width:100%">
              <thead class="table-dark" style="background-color: #184A45;">
                <tr style="font-size: small;">
                  <th>#</th>
                  <th style="width: 100px;">@lang('lang.invoice_date')</th>
              ...
              <tbody id="tableData">
                ...
                <tr style="font-size: small;">
                  ...
                  <td>
                    ...
                    <span data-qoute_id="{{$value['id']}}" class="sendmail">
                      <div data-id="{{ $value['id'] }}" class=" mt-1 bg-primary text-white f-w-bold rounded-1 send_mail" style="cursor:pointer; width: 100%; height: 100%; padding-top: 7px; padding-bottom: 7px; padding-left: 12px; padding-right: 13px; justify-content: center; align-items: center; display: inline-flex" data-toggle="modal" data-target="#invoiceMail">
                  ...
                  <td>
                    <button class="btn btn_status_q">
                      ...
                      <span data-qoute_id="{{$value['id']}}">
                        <div class="bg-info text-white f-w-bold rounded-1" style="width: 100%; height: 100%; padding-top: 7px; padding-bottom: 7px; padding-left: 12px; padding-right: 13px; justify-content: center; align-items: center; display: inline-flex">
                  ...
                  <td class="">
                    <div class="d-flex my-auto">
                      ...
                      <form method="POST" action="/add_invoice" class="mb-0">
                        @csrf
                      ...
                      <button data-id="{{ $value['id'] }}" data-role="{{ $user->role}}" id="InvoiceDetail_btn" class="btn p-0 invoiceDetail_view" data-toggle="modal" data-target="#invoicedetail">
                        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
