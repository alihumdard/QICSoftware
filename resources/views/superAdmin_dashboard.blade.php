    ...
    <div class="container">
      <div class="row mb-2">
        <div class="col-lg-6 col-xl-4 col-sm-6 mb-2">
          <div class=" bg-white p-3" style="border-radius: 20px; box-shadow: 0px 0px 4px 1px rgba(0,0,0,0.3); -webkit-box-shadow: 0px 0px 4px 1px rgba(0,0,0,0.3);-moz-box-shadow: 0px 0px 4px 1px rgba(0,0,0,0.3);">
