                ...
                <form action="contractStore" id="formData" method="post">
                    <div class="row">
                        ...
                        <div class="col-lg-{{ ($user->role == user_roles('3')) ? (($user->role == user_roles('2')) ? '3' : '4') : '3' }} col-md-6 col-sm-12  my-2">
                            ...
                            <input required type="date" name="start_date" id="c_st_date" value="{{ ($duplicate_trip ?? '' == 1) ? date('Y-m-d') : ((isset($data['id'])) ? $data['start_date'] : date('Y-m-d') ) }}" min="{{ ($duplicate_trip ?? '' == 1) ? date('Y-m-d') : ((isset($data['id'])) ? $data['start_date'] : date('Y-m-d') ) }}" class="form-control">
                        ...
                        <div class="col-lg-{{ ($user->role == user_roles('3')) ? (($user->role == user_roles('2')) ? '3' : '4') : '3' }} col-md-6 col-sm-12  my-2">
                            ...
                            <input required type="date" name="end_date" id="c_ex_date" value="{{ ($duplicate_trip ?? '' == 1) ? date('Y-m-d') : ((isset($data['id'])) ? $data['end_date'] : date('Y-m-d') ) }}" min="{{ ($duplicate_trip ?? '' == 1) ? date('Y-m-d') : ((isset($data['id'])) ? $data['end_date'] : date('Y-m-d') ) }}" class="form-control">
